...
exports.run = function(port, devops_directory, host) {
  ...
  app.get(
      ...
      function(req, res) {
        ...
        middleware.versionone(devops)(req, res, function() {
  ...
  app.get(
      ...
      function(req, res) {
        ...
        middleware.github(devops)(req, res, function() {
  ...
  app.get(
      ...
      function(req, res) {
        ...
        async.parallel([
            function(cb) {
              middleware.pagerduty(devops)(req, res, cb);
            }, function(cb) {
              // This takes too long.
              ...
              middleware.github(devops)(req, res, cb);
            }
          ], function() {
