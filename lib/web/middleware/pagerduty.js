      ...
      function(data) {
        try {
          ...
          if (req.devops.pagerduty.data.entries) {
            for (var k = 0; k < req.devops.pagerduty.data.entries.length; k++) {
              var entry = req.devops.pagerduty.data.entries[k];
              for (var i = 0; i < req.devops.contacts.length; i++) {
                for (var j = 0; j < req.devops.contacts[i].members.length; j++) {
                  var contact = req.devops.contacts[i].members[j];
